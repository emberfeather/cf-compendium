...
<cfset datagrid.addColumn('Actions', {
		class = 'phantom align-right'
	}) />
...
<blockquote>
	<code>
		data = [
				{
					firstname = "John", lastName= "Doe", actions = "Action"
				},
				{
					firstname = "Jane", lastName="Doe", actions = "Action"
				},
				{
					firstname = "Bobby", lastName="Joe", actions = "Action"
				}
			]<br />
